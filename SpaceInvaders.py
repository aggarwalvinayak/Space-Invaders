...
def initial():
    ...
    ship = pygame.image.load('tank.png').convert_alpha()  # This line has to modified to get spaceship object
...
invader2 = pygame.image.load('i3.png').convert_alpha()  # This line to be replaced by Invader image
invader3 = pygame.image.load('i2.png').convert_alpha()  # This line to be replaced by Invader image
